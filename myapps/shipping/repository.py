...
class Repository(repository.Repository):
    ...
    def get_available_shipping_methods(self, basket, user=None, shipping_addr=None, request=None, **kwargs):
        ...
        all_methods = (methods.Reserve(), methods.PochtaRu())
        if shipping_addr and shipping_addr.state == 'VLZ':            
            
            all_methods = (methods.Reserve(), methods.Vlzship(), methods.PochtaRu())
            ...
            all_methods = (methods.Reserve(), methods.Sraship(), methods.PochtaRu())
